...
docker-compose -p ${PROJECT} exec couchbaseserver couchbase-cli cluster-init --services data,index,query --cluster-username=admin --cluster-password=123456 --cluster-ramsize=256
