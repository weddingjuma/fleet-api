...
namespace :mapotempo_fleet do
  ...
  task :populate, [] => :environment do |_task, _args|
    ...
    # to do => in progress
    # to do => uncompleted
    FactoryBot.create(:mission_status_action, company: company, label: nil, previous_mission_status_type: todo_status_type, next_mission_status_type: in_progress_status_type)
    FactoryBot.create(:mission_status_action, company: company, label: nil, previous_mission_status_type: todo_status_type, next_mission_status_type: uncompleted_status_type)
    # in progress => to do
    # in progress => completed
    # in progress => uncompleted
    FactoryBot.create(:mission_status_action, company: company, label: nil, previous_mission_status_type: in_progress_status_type, next_mission_status_type: completed_status_type)
    FactoryBot.create(:mission_status_action, company: company, label: nil, previous_mission_status_type: in_progress_status_type, next_mission_status_type: todo_status_type)
    FactoryBot.create(:mission_status_action, company: company, label: nil, previous_mission_status_type: in_progress_status_type, next_mission_status_type: uncompleted_status_type)
    # completed => in progress
    FactoryBot.create(:mission_status_action, company: company, label: nil, previous_mission_status_type: completed_status_type, next_mission_status_type: in_progress_status_type)
    # uncompleted => to do
    FactoryBot.create(:mission_status_action, company: company, label: nil, previous_mission_status_type: uncompleted_status_type, next_mission_status_type: todo_status_type)
